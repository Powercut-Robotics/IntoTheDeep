...
@I2cDeviceType
@DeviceProperties(name = "TCS34725", description = "Colour Sensor Sensor", xmlTag = "TCS34725")
public class TCS34725 extends I2cDeviceSynchDevice<I2cDeviceSynch> implements ColorSensor {
    ...
    public TCS34725(I2cDeviceSynch deviceClient, boolean isOwned) {
        this(I2CADDR_DEFAULT, deviceClient, null, isOwned);
    }

    public TCS34725(I2cAddr addr, I2cDeviceSynch deviceClient, DigitalChannel digitalChannel, boolean isOwned) {
