...
public class settings {
    ...
    public static double lowerArmRaised = 0.45;
    public static double lowerArmLowered = 0.8;

    public static double upperArmRaised = 0.45;
    public static double upperArmIntake = 0.6;
    public static double upperArmLowered = 0.8;
